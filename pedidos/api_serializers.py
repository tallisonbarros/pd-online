...
def serialize_pedido_api(pedido):
    return {
        ...
        "turno": pedido.turno.codigo if pedido.turno_id else "principal",
        "turno_label": pedido.turno.nome if pedido.turno_id else "Atendimento principal",
        ...
        "pagamento_recebido_em": pedido.pagamento_recebido_em,
