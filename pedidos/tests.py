...
class CozinhaAccessTests(TestCase):
    ...
    def test_dashboard_counts_finished_daily_orders_by_channel_and_phone_recurrence(self):
        ...
        self.assertContains(response, "marmitas vendidas")
        self.assertContains(response, "Pedidos por canal")
        ...
        self.assertNotContains(response, "Canais de venda")
        ...
        self.assertNotContains(response, 'data-dashboard-card-detail="Marmitas produzidas:Vendidas"')
