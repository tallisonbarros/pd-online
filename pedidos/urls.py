...
urlpatterns = [
    ...
    path("api/metrics/event/", views.api_metric_event, name="api_metric_event"),
    ...
    path("controle/exportar/", views.exportar_pedidos_xlsx, name="exportar_pedidos_xlsx"),
    path("controle/contabil/", views.contabil, name="contabil"),
    path("controle/contabil/caixa/", views.contabil_caixa, name="contabil_caixa"),
    path("controle/contabil/ifood/", views.contabil_ifood, name="contabil_ifood"),
    path("controle/contabil/conta/", views.contabil_conta, name="contabil_conta"),
    path("controle/contabil/ajustes/", views.contabil_ajustes, name="contabil_ajustes"),
    ...
    path("controle/pratos/<int:prato_id>/duplicar/", views.duplicar_prato, name="duplicar_prato"),
    path("controle/pratos/<int:prato_id>/excluir/", views.excluir_prato, name="excluir_prato"),
    ...
    path("controle/bebidas/<int:bebida_id>/duplicar/", views.duplicar_bebida, name="duplicar_bebida"),
    path("controle/bebidas/<int:bebida_id>/excluir/", views.excluir_bebida, name="excluir_bebida"),
    ...
    path("controle/adicionais/<int:adicional_id>/duplicar/", views.duplicar_adicional, name="duplicar_adicional"),
    path("controle/adicionais/<int:adicional_id>/excluir/", views.excluir_adicional, name="excluir_adicional"),
    ...
    path("controle/pedido/<int:pedido_id>/duplicar/", views.duplicar_pedido_admin, name="duplicar_pedido_admin"),
